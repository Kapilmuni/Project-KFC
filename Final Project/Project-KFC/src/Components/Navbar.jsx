...
const links=[
    ...
    {
        to:'',
        label:<Text fontSize="13px"><b>₹0</b></Text>,
        key: "price"
    },
    {
        to:"/signIn",
        label:<Image height="50px"  src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDLJP0B2-dMhPMWLx7DWjv8G8PPa6fDlpfQw&s' />,
        key: "cart_icon"
    },
]
...
export default function Navbar(){
    ...
    return (<>
        ...
        <Box bgColor="white"  boxShadow="rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px">
